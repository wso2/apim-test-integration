...
wget -O "./${db_engine}/apim.sql" "https://raw.githubusercontent.com/wso2/apim-test-integration/refs/heads/4.4.0-profile-automation/scripts/mysql/apim.sql" || { echo 'Failed to download DB script.'; exit 1; }
