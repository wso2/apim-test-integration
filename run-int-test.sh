...
cd $INT_TEST_MODULE_DIR  && mvn clean install -Dorg.slf4j.simpleLogger.log.org.apache.maven.cli.transfer.Slf4jMavenTransferListener=warn -Ptestgrid -Dhttp.keepAlive=false -Dmaven.wagon.http.pool=false
